...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no"
        name="viewport">
    <title>Login &mdash; IDN Connect</title>
            ...
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">IDN Connect</span>
                        </h4>
                        ...
                        <form method="POST"
                            ...
                            novalidate=""> <?php echo csrf_field(); ?>
                            ...
                            <div class="mt-5 text-center">
                                Don't have an account? <a href="<?php echo e(url('register')); ?>">Create new one</a>
                            </div>
                        </form>

                        <div class="text-small mt-5 text-center">
                            Copyright &copy; IDN Connect 2025. Made with 💙 by Dadigital
                            <div class="mt-2">
...
<?php /**PATH /Users/haidarmiqdad/projects/laravelProject/laravel-news/resources/views/pages/auth/login.blade.php ENDPATH**/ ?>