...
class PermissionsTableSeeder extends Seeder
{
    ...
    {
        //permission for news
        Permission::create(['name' => 'news.index', 'guard_name' => 'api']);
        Permission::create(['name' => 'news.create', 'guard_name' => 'api']);
        Permission::create(['name' => 'news.edit', 'guard_name' => 'api']);
        Permission::create(['name' => 'news.delete', 'guard_name' => 'api']);
        ...
        //permission for objectNews
        Permission::create(['name' => 'objectNews.index', 'guard_name' => 'api']);
        Permission::create(['name' => 'objectNews.create', 'guard_name' => 'api']);
        Permission::create(['name' => 'objectNews.edit', 'guard_name' => 'api']);
        Permission::create(['name' => 'objectNews.delete', 'guard_name' => 'api']);
